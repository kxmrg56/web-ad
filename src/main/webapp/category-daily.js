...
async function loadProductsFromDatabase() {
    try {
        // 调用API获取商品数据 - 注意：category=daily
        const response = await fetch('/shopping_web_war_exploded/api/products?category=daily');
        ...
        console.log('成功从数据库加载', categoryProducts.length, '个日用文创商品');
        ...
        categoryProducts = [
            {
                id: 701,
                name: '创意文具礼盒',
                description: '精美设计，实用收纳，办公学习，文创礼品',
                price: 199,
                originalPrice: 299,
                stock: 150
            }
