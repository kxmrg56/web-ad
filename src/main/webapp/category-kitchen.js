...
async function loadProductsFromDatabase() {
    try {
        // 调用API获取商品数据 - 注意：category=kitchen
        const response = await fetch('/shopping_web_war_exploded/api/products?category=kitchen');
        ...
        console.log('成功从数据库加载', categoryProducts.length, '个居家厨具商品');
        ...
        categoryProducts = [
            {
                id: 601,
                name: '不粘锅套装',
                description: '德国工艺，健康涂层，易清洁，厨房必备厨具',
                price: 399,
                originalPrice: 599,
                stock: 80
            }
