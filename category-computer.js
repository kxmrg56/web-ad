...
async function loadProductsFromDatabase() {
    try {
        // 调用API获取商品数据 - 注意：category=computer
        const response = await fetch('/shopping_web_war_exploded/api/products?category=computer');
        ...
        console.log('成功从数据库加载', categoryProducts.length, '个电脑办公商品');
